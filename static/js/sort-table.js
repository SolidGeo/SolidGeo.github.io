...
sortTable.init = function () {
    ...
    for (var k = 0; k < table.rows.length; k++) {
        table.rows[k].cells[5].style.fontWeight = 'bold'
        table.rows[k].cells[1].style.fontWeight = 'bold'
    }
    table.rows[2].cells[1].innerHTML = `<b class="best-score-text">${table.rows[2].cells[1].innerHTML} 🥇<b>`;
    table.rows[2].cells[5].innerHTML = `<b class="best-score-text">${table.rows[2].cells[5].innerHTML}<b>`;

    table.rows[3].cells[1].innerHTML = `<b class="best-score-text">${table.rows[3].cells[1].innerHTML} 🥈<b>`;
    table.rows[3].cells[5].innerHTML = `<b class="best-score-text">${table.rows[3].cells[5].innerHTML}<b>`;

    table.rows[4].cells[1].innerHTML = `<b class="best-score-text">${table.rows[4].cells[1].innerHTML} 🥉<b>`;
    table.rows[4].cells[5].innerHTML = `<b class="best-score-text">${table.rows[4].cells[5].innerHTML}<b>`;
};
